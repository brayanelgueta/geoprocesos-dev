...
/* harmony import */ var _helpers_getSessionToken__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../helpers/getSessionToken */ "./your-extensions/helpers/getSessionToken.ts");
...
const Widget = (props) => {
    ...
    const selectedImageries = (0,react_redux__WEBPACK_IMPORTED_MODULE_11__.useSelector)((state) => { var _a; return (_a = state.myState) === null || _a === void 0 ? void 0 : _a.selectedImages; });
    const geoprocess = (0,react_redux__WEBPACK_IMPORTED_MODULE_11__.useSelector)((state) => { var _a; return (_a = state.myState) === null || _a === void 0 ? void 0 : _a.geoprocess; });
    const selectedSensor = (0,react_redux__WEBPACK_IMPORTED_MODULE_11__.useSelector)((state) => { var _a; return (_a = state.myState) === null || _a === void 0 ? void 0 : _a.selectedSensor; });
    ...
    const incendio = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (jimuMapView) {
            try {
                const existingLayer = jimuMapView.view.map.layers.find((layer) => layer.title === t("floodLayer"));
                if (existingLayer) {
                    jimuMapView.view.map.remove(existingLayer);
                }
                ...
                const token = (0,_helpers_getSessionToken__WEBPACK_IMPORTED_MODULE_10__.getSessionToken)();
    ...
    const inundacion = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            if (selectedImageries.length == 0) {
                ...
                if (jimuMapView) {
                    const existingLayer = jimuMapView.view.map.layers.find((layer) => layer.title === t("fireLayer"));
                    if (existingLayer) {
                        jimuMapView.view.map.remove(existingLayer);
                    }
                    let imagen1 = (_a = selectedImageries[0]) === null || _a === void 0 ? void 0 : _a.OBJECTID;
            ...
            react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", { className: "zona-riesgo-container" },
                ...
                react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", { className: "zona-riesgo-buttons" },
                    loadingIncendio === true ? (react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(jimu_ui__WEBPACK_IMPORTED_MODULE_6__.Button, { size: "sm", type: "primary" },
                        react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(jimu_ui__WEBPACK_IMPORTED_MODULE_6__.Loading, { type: "DONUT", height: 20, width: 20 }))) : (react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(jimu_ui__WEBPACK_IMPORTED_MODULE_6__.Button, { onClick: incendio, size: "sm", type: "primary" }, t("incendio"))),
                    loadingInundacion === true ? (react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(jimu_ui__WEBPACK_IMPORTED_MODULE_6__.Button, { size: "sm", type: "primary" },
                        react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(jimu_ui__WEBPACK_IMPORTED_MODULE_6__.Loading, { type: "DONUT", height: 20, width: 20 }))) : (react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement(jimu_ui__WEBPACK_IMPORTED_MODULE_6__.Button, { onClick: inundacion, size: "sm", type: "primary" }, t("inundacion"))))))));
};
