...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[3].use[1]!./node_modules/resolve-url-loader/index.js??ruleSet[1].rules[3].use[2]!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[3].use[3]!./your-extensions/widgets/symbolRenderer/src/runtime/assets/style.css":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[3].use[1]!./node_modules/resolve-url-loader/index.js??ruleSet[1].rules[3].use[2]!./node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[3].use[3]!./your-extensions/widgets/symbolRenderer/src/runtime/assets/style.css ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************/
...
/* Encabezado del FloatingPanel */
.symbologyContainer .jimu-widget {
  font-size: 20px;
  font-weight: bold;
  color: #ffffff;
}

.symbologyContainer .headerTitle {
  font-size: 20px !important;
  font-weight: bold;
}

/* Títulos de indicadores (ej: NDWI) */
.symbologyContainer h1,
.symbologyContainer h2,
.symbologyContainer h3,
.symbologyContainer h4 {
...
/* Fórmulas */
.symbologyContainer p:nth-child(2) {
  font-family: "Courier New", monospace;
  font-weight: 600;
  color: #aee4ff;
}

/* Barra de color (por ahora un placeholder) */
.ndwicolorbar {
  margin-top: 1rem;
  width: 100%;
  height: 20px;
  border-radius: 4px;
  background: linear-gradient(to right, #dff6ff, #0077be);
}
...
.colorbar {
  ...
  height: 20px;
  border-radius: 4px;
  background: linear-gradient(to right, #228B22, #ADFF2F, #FFD700, #FF4500);
}`, "",{"version":3,"sources":["webpack://./../../../geoprocesos%20exprience%20builder/ArcGISExperienceBuilder/client/your-extensions/widgets/symbolRenderer/src/runtime/assets/style.css","webpack://./your-extensions/widgets/symbolRenderer/src/runtime/assets/style.css"],"names":[],"mappings":"AAAA,gBAAgB;ACAhB,mCAAA;AACA;EACE,yBAAA,EAAA,yBAAA;EACA,cAAA,EAAA,iBAAA;EACA,kDAAA;EACA,aAAA;EACA,kBAAA;EACA,4CAAA;EACA,gBAAA;ADEF;;ACCA,iCAAA;AACA;EACE,eAAA;EACA,iBAAA;EACA,cAAA;ADEF;;ACAA;EACE,0BAAA;EACA,iBAAA;ADGF;;ACAA,sCAAA;AACA;;;;EAIE,qBAAA;EACA,iBAAA;EACA,cAAA;ADGF;;ACAA,0BAAA;AACA;EACE,gBAAA;EACA,eAAA;EACA,gBAAA;EACA,cAAA;ADGF;;ACAA,aAAA;AACA;EACE,qCAAA;EACA,gBAAA;EACA,cAAA;ADGF;;ACAA,8CAAA;AACA;EACE,gBAAA;EACA,WAAA;EACA,YAAA;EACA,kBAAA;EACA,uDAAA;ADGF;;ACAA;EACE,gBAAA;EACA,WAAA;EACA,YAAA;EACA,kBAAA;EACA,yEAAA;ADGF","sourcesContent":["@charset \"UTF-8\";\n/* Contenedor principal del panel */\n.symbologyContainer {\n  background-color: #001f3f; /* azul oscuro de fondo */\n  color: #ffffff; /* texto blanco */\n  font-family: \"Segoe UI\", Roboto, Arial, sans-serif;\n  padding: 1rem;\n  border-radius: 8px;\n  box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.25);\n  max-width: 300px;\n}\n\n/* Encabezado del FloatingPanel */\n.symbologyContainer .jimu-widget {\n  font-size: 20px;\n  font-weight: bold;\n  color: #ffffff;\n}\n\n.symbologyContainer .headerTitle {\n  font-size: 20px !important;\n  font-weight: bold;\n}\n\n/* Títulos de indicadores (ej: NDWI) */\n.symbologyContainer h1,\n.symbologyContainer h2,\n.symbologyContainer h3,\n.symbologyContainer h4 {\n  margin: 0 0 0.75rem 0;\n  font-weight: bold;\n  color: #ffffff;\n}\n\n/* Párrafos descriptivos */\n.symbologyContainer p {\n  margin: 0.4rem 0;\n  font-size: 14px;\n  line-height: 1.5;\n  color: #f0f0f0;\n}\n\n/* Fórmulas */\n.symbologyContainer p:nth-child(2) {\n  font-family: \"Courier New\", monospace;\n  font-weight: 600;\n  color: #aee4ff;\n}\n\n/* Barra de color (por ahora un placeholder) */\n.ndwicolorbar {\n  margin-top: 1rem;\n  width: 100%;\n  height: 20px;\n  border-radius: 4px;\n  background: linear-gradient(to right, #dff6ff, #0077be);\n}\n\n.colorbar {\n  margin-top: 1rem;\n  width: 100%;\n  height: 20px;\n  border-radius: 4px;\n  background: linear-gradient(to right, #228B22, #ADFF2F, #FFD700, #FF4500);\n}","@charset \"UTF-8\";\n/* Contenedor principal del panel */\n.symbologyContainer {\n  background-color: #001f3f; /* azul oscuro de fondo */\n  color: #ffffff; /* texto blanco */\n  font-family: \"Segoe UI\", Roboto, Arial, sans-serif;\n  padding: 1rem;\n  border-radius: 8px;\n  box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.25);\n  max-width: 300px;\n}\n\n/* Encabezado del FloatingPanel */\n.symbologyContainer .jimu-widget {\n  font-size: 20px;\n  font-weight: bold;\n  color: #ffffff;\n}\n\n.symbologyContainer .headerTitle {\n  font-size: 20px !important;\n  font-weight: bold;\n}\n\n/* Títulos de indicadores (ej: NDWI) */\n.symbologyContainer h1,\n.symbologyContainer h2,\n.symbologyContainer h3,\n.symbologyContainer h4 {\n  margin: 0 0 0.75rem 0;\n  font-weight: bold;\n  color: #ffffff;\n}\n\n/* Párrafos descriptivos */\n.symbologyContainer p {\n  margin: 0.4rem 0;\n  font-size: 14px;\n  line-height: 1.5;\n  color: #f0f0f0;\n}\n\n/* Fórmulas */\n.symbologyContainer p:nth-child(2) {\n  font-family: \"Courier New\", monospace;\n  font-weight: 600;\n  color: #aee4ff;\n}\n\n/* Barra de color (por ahora un placeholder) */\n.ndwicolorbar {\n  margin-top: 1rem;\n  width: 100%;\n  height: 20px;\n  border-radius: 4px;\n  background: linear-gradient(to right, #dff6ff, #0077be);\n}\n\n.colorbar {\n  margin-top: 1rem;\n  width: 100%;\n  height: 20px;\n  border-radius: 4px;\n  background: linear-gradient(to right, #228B22, #ADFF2F, #FFD700, #FF4500);\n}"],"sourceRoot":""}]);
// Exports
...
/***/ "./your-extensions/widgets/symbolRenderer/src/runtime/assets/style.css":
/*!*****************************************************************************!*\
  !*** ./your-extensions/widgets/symbolRenderer/src/runtime/assets/style.css ***!
  \*****************************************************************************/
...
/***/ "./your-extensions/widgets/symbolRenderer/src/runtime/translations.ts":
/*!****************************************************************************!*\
  !*** ./your-extensions/widgets/symbolRenderer/src/runtime/translations.ts ***!
  \****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const translations = {
    es: {
        NDWITitle: "Índice de Agua de Diferencia Normalizada (NDWI).",
        NDWIFormula1: "NDWI es calculado como",
        NDWIFormula2: "(VERDE - NIR) / (VERDE + NIR).",
        NDWIDescription: "Indicador utilizado para delinear masas de agua y monitorear  su contenido, separándolas de la vegetación y el suelo.",
        CGITitle: "Índice de Clorofila Verde (CGI).",
        CGIFormula1: "CGI es calculado como",
        CGIFormula2: "(NIR / VERDE) - 1.",
        CGIDescription: "Indicador del contenido de clorofila en las hojas, útil para estimar la salud, el estrés y el estado de nitrógeno de la vegetación",
        NDVITitle: "Índice de Vegetación de Diferencia Normalizada (NDVI) con un mapa de colores aplicado.",
        NDVIFormula1: "NDVI es calculado como",
        NDVIFormula2: "(NIR - R) / (NIR + R).",
        NDVIDescription: "Indicador que señala el verdor, densidad y salud de la vegetación en cada píxel de una imagen satelital.",
        SAVITitle: "Índice de Vegetación Ajustado al Suelo (SAVI).",
        SAVIFormula1: "SAVI es calculado como",
        SAVIFormula2: "((NIR - R) / (NIR + R+ L)) * (1 + L).",
        SAVIDescription: "Indicador que minimiza la influencia del brillo del suelo en zonas con vegetación dispersa, midiendo el verdor y la salud de las plantas.",
    },
    en: {
        NDWITitle: "Normalized Difference Water Index (NDWI).",
        NDWIFormula1: "NDWI is calculated as",
        NDWIFormula2: "(GREEN - NIR) / (GREEN + NIR).",
        NDWIDescription: "Indicator used to delineate bodies of water and monitor their contents, separating them from vegetation and soil.",
        CGITitle: "Chlorophyll Green Index (CGI).",
        CGIFormula1: "CGI is calculated as",
        CGIFormula2: "(NIR / GREEN) - 1.",
        CGIDescription: "Indicator of chlorophyll content in leaves, useful for estimating the health, stress and nitrogen status of vegetation",
        NDVITitle: "Normalized Difference Vegetation Index (NDVI) with a color map applied.",
        NDVIFormula1: "NDVI is calculated as",
        NDVIFormula2: "(NIR - R) / (NIR + R).",
        NDVIDescription: "Indicator that shows the greenness, density, and health of vegetation in each pixel of a satellite image..",
        SAVITitle: "Soil Adjusted Vegetation Index (SAVI).",
        SAVIFormula1: "SAVI is calculated as",
        SAVIFormula2: "((NIR - R) / (NIR + R+ L)) * (1 + L).",
        SAVIDescription: "Indicator that minimizes the influence of ground brightness in areas with sparse vegetation, measuring the greenness and health of plants.",
    },
};
...
"use strict";
/*!***********************************************************************!*\
  !*** ./your-extensions/widgets/symbolRenderer/src/runtime/widget.tsx ***!
  \***********************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
/* harmony import */ var _assets_style_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./assets/style.css */ "./your-extensions/widgets/symbolRenderer/src/runtime/assets/style.css");
...
/* harmony import */ var _translations__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./translations */ "./your-extensions/widgets/symbolRenderer/src/runtime/translations.ts");
...
const Widget = (props) => {
    ...
    const onlineProcessor = (0,react_redux__WEBPACK_IMPORTED_MODULE_7__.useSelector)((state) => { var _a; return (_a = state.myState) === null || _a === void 0 ? void 0 : _a.onlineProcessor; });
    //Constante del Mapa
    ...
    return ((onlineProcessor === null || onlineProcessor === void 0 ? void 0 : onlineProcessor.valueOf()) > 1 && (jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement(jimu_ui__WEBPACK_IMPORTED_MODULE_6__.FloatingPanel, { autoSize: true, className: 'symbologyContainer', placement: 'bottom', defaultPosition: { x: window.innerWidth - 350, y: window.innerHeight - 500 }, headerTitle: '', onHeaderClose: closeWidget },
        jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", { className: "jimu-widget widget-starter" },
            props.useMapWidgetIds && props.useMapWidgetIds.length === 1 && (jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement(jimu_arcgis__WEBPACK_IMPORTED_MODULE_2__.JimuMapViewComponent, { useMapWidgetId: props.useMapWidgetIds[0], onActiveViewChange: activeViewChangeHandler })),
            jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", { className: 'headerTitle' }, onlineProcessor.valueOf() === 2 ? `NDWI` : onlineProcessor.valueOf() === 3 ? "CGI" : onlineProcessor.valueOf() === 4 ? "NDVI" : "SAVI"),
            (onlineProcessor === null || onlineProcessor === void 0 ? void 0 : onlineProcessor.valueOf()) === 2 &&
                jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", null,
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", { className: "title" }, t("NDWITitle")),
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", { className: "formula" },
                        t("NDWIFormula1"),
                        " ",
                        t("NDWIFormula2")),
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", null, t("NDWIDescription")),
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", { className: "ndwicolorbar" })),
            (onlineProcessor === null || onlineProcessor === void 0 ? void 0 : onlineProcessor.valueOf()) === 3 &&
                jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", null,
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", { className: "title" }, t("CGITitle")),
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", { className: "formula" },
                        t("CGIFormula1"),
                        " ",
                        t("CGIFormula2")),
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", null, t("CGIDescription")),
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", { className: "colorbar" })),
            (onlineProcessor === null || onlineProcessor === void 0 ? void 0 : onlineProcessor.valueOf()) === 4 &&
                jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", null,
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", { className: "title" }, t("NDVITitle")),
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", { className: "formula" },
                        t("NDVIFormula1"),
                        " ",
                        t("NDVIFormula2")),
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", null, t("NDVIDescription")),
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", { className: "colorbar" })),
            (onlineProcessor === null || onlineProcessor === void 0 ? void 0 : onlineProcessor.valueOf()) === 5 &&
                jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", null,
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", { className: "title" }, t("SAVITitle")),
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", { className: "formula" },
                        t("SAVIFormula1"),
                        " ",
                        t("SAVIFormula2")),
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", null, t("SAVIDescription")),
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", { className: "colorbar" }))))));
};
