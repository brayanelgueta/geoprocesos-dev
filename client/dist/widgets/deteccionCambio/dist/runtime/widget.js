...
const Widget = (props) => {
    ...
    const changeGeoProcess = (0,react_redux__WEBPACK_IMPORTED_MODULE_11__.useSelector)((state) => { var _a; return (_a = state.myState) === null || _a === void 0 ? void 0 : _a.isReady; });
    ...
    const ejecutarConsulta = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield fetch(`/getChangeDetection`, {
                method: "POST",
                headers: {
    ...
    const loadImageryLayer = (url_file) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const [ImageryTileLayer] = yield (0,esri_loader__WEBPACK_IMPORTED_MODULE_4__.loadModules)([
        ...
        try {
            ...
            if (jimuMapView && imageryLayer) {
                const loadEsriModules = () => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    if (!isNaN(selectedImageries[0].OBJECTID) &&
                        !isNaN(selectedImageries[1].OBJECTID)) {
                        ...
                        if (results.features.length === 2) {
                            ...
                            if (intersectan) {
                                ...
                                document.getElementById("img1Data").style.color =
                                    "rgb(78, 248, 89)";
                                document.getElementById("img2Data").style.color =
                                    "rgb(78, 248, 89)";
                                document.getElementById("validacionCD").style.color =
                                    "rgb(78, 248, 89)";
                                ...
                                document.getElementById("validacionCD").style.color =
                                    "rgb(248, 78, 78)";
                                document.getElementById("validacionCD").innerText =
                                    t("invalid");
                            }
                        }
                        else {
    ...
    return (jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", { className: "jimu-widget widgetChangeDetection" },
        ...
        jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", { className: "homeCD" },
            ...
            jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement(_components_TitleWithTooltip__WEBPACK_IMPORTED_MODULE_9__["default"], { title: t("widgetLabel"), description: t("widgetDescription") }),
            selectedImageries && (selectedImageries === null || selectedImageries === void 0 ? void 0 : selectedImageries.length) < 2 ? (jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", { className: "change-detection-description" },
                jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", null, t("text")))) : (jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", { className: "contentWidgetsCD" }, isEjecuted === true ? (jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", { className: "graphic-container" },
                jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("p", null, t("graphicLabel")),
                jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("img", { id: "graphic-image", src: imgRango2 }))) : (jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", { className: "main-content", id: "btn1Data" },
                ...
                jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement("div", { className: "contentBtnFlujo" }, !isValid ? (loading === true ? (jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement(jimu_ui__WEBPACK_IMPORTED_MODULE_5__.Button, { size: "sm", type: "primary" },
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement(jimu_ui__WEBPACK_IMPORTED_MODULE_5__.Loading, { type: "DONUT", height: 20, width: 20 }))) : (jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement(jimu_ui__WEBPACK_IMPORTED_MODULE_5__.Button, { onClick: validarSuperposicion, size: "sm" }, t("validate")))) : loadQuery === true ? (jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement(jimu_ui__WEBPACK_IMPORTED_MODULE_5__.Button, { size: "sm", type: "primary" },
                    jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement(jimu_ui__WEBPACK_IMPORTED_MODULE_5__.Loading, { type: "DONUT", height: 20, width: 20 }))) : (jimu_core__WEBPACK_IMPORTED_MODULE_1__.React.createElement(jimu_ui__WEBPACK_IMPORTED_MODULE_5__.Button, { onClick: ejecutarConsulta, size: "sm", type: "primary" }, t("runQuery")))))))))));
};
