...
const Widget = (props: AllWidgetProps<any>) => {
  ...
  const eventoPunto = () => {
    const test2 = document.getElementsByClassName(
      "section-content"
    )[0] as HTMLDivElement;
  ...
  const toggleWidgetVisibility = (index) => {
    const sectionContent =
      document.getElementsByClassName("section-content")[0];
    if (sectionContent) {
          ...
          <div className="category-row">
            <div
              ...
              style={{
                ...
                boxShadow:
                  selectedCategory === 1 ? "0 0 0 1px #ffffff" : "none",
              }}
            ...
            <div
              ...
              style={{
                ...
                boxShadow:
                  selectedCategory === 2 ? "0 0 0 1px #ffffff" : "none",
              }}
            ...
            <div className="options-container">
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    selectedOption === 0 ? "0 0 0 1px #ffffff" : "none",
                }}
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    selectedOption === 1 ? "0 0 0 1px #ffffff" : "none",
                }}
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    selectedOption === 3 ? "0 0 0 1px #ffffff" : "none",
                }}
            ...
            <div className="options-container">
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    selectedOption === 2 ? "0 0 0 1px #ffffff" : "none",
                }}
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    selectedOption === 4 ? "0 0 0 1px #ffffff" : "none",
                }}
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    selectedOption === 5 ? "0 0 0 1px #ffffff" : "none",
                }}
